...
func (srv *UserService) Get(ctx context.Context, req *pb.Request, res *pb.Response) error {
...
func (srv *UserService) Create(ctx context.Context, req *pb.Request, res *pb.Response) error {
	// 对密码进行哈希加密
